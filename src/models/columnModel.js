...
const createNew = async (data) => {
  try {
    ...
    const createColumn = await GET_DB().collection(COLUMN_COLLECTION_NAME).insertOne(newColumnToAdd) //insertOne trong MongoDB
    return createColumn
...
//Nhiệm vụ của func này là cập nhập push 1 cái giá trị CardId vào cuối mảng cardOrderIds
